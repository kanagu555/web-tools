...
export const metadata: Metadata = {
  ...
  description: 'A comprehensive collection of 50+ free online developer tools including PDF converters, calculators, text formatters, and more.',
  keywords: [
    'developer tools',
    'online tools',
    'PDF converter',
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${inter.variable} loading`} suppressHydrationWarning>
      <head>
      ...
      <body className={`${inter.className} antialiased min-h-screen`} suppressHydrationWarning>
        ...
        <StructuredData data={[generateWebApplicationSchema(), generateOrganizationSchema()]} />
        <ErrorBoundary>
          <ThemeProvider>
