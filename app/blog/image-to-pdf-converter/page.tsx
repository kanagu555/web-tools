...
export const metadata: Metadata = {
  ...
  description:
    "Learn how to convert JPG, PNG, and other images to PDF format online for free. Step-by-step guide with tips for best results using our Image to PDF converter tool.",
  keywords: [
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://www.kodekit.in/social/image-to-pdf-converter-kodekit.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description:
      "Learn how to convert JPG, PNG, and other images to PDF format online for free. Step-by-step guide with tips for best results using our Image to PDF converter tool.",
    images: [
      "https://www.kodekit.in/social/image-to-pdf-converter-kodekit.png",
    ],
  },
  robots: {
    index: true,
