...
![favicon](https://github.com/user-attachments/assets/ce1d3e41-d251-41a0-bb95-19ab08c98284)
...
- **PDF Editor**: Edit text, images, and other elements in PDF files

### 📝 Text Tools

- **Word Count**: Count words, characters, sentences, and paragraphs
- **Text Formatter**: Format and beautify text with various options
...
- **Lorem Ipsum Generator**: Generate placeholder text with customization options
...
- **Scientific Calculator**: Perform complex mathematical calculations
...
Please make sure to follow our coding standards and write tests for new features.
