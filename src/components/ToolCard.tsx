...
import { FileText, Text, Palette, Code, FileStack, Scissors, FileMinus, FileEdit, AlignCenter, Languages, TextCursor, Quote, Image, Projector as VectorBezier, Braces, FileJson } from 'lucide-react';
