...
const TimestampConverter = () => {
  ...
  const seoData = generateToolSEO(
    "Timestamp Converter",
    "Convert Unix timestamps to human-readable dates and vice versa. Supports multiple formats, timezones, and provides detailed conversion results with milliseconds, microseconds, and nanoseconds precision",
    "time"
  );
  ...
  const webAppData = generateWebAppData(
    "Timestamp Converter",
    "Convert Unix timestamps to human-readable dates and vice versa. Supports multiple formats, timezones, and provides detailed conversion results",
    "time"
  );

  const howToData = generateHowToData("Timestamp Converter", [
    {
      name: "Choose Conversion Type",
      text: "Select either 'Timestamp → Date' to convert Unix timestamps to readable dates, or 'Date → Timestamp' to convert dates to Unix timestamps",
    },
    {
      name: "Enter Your Data",
      text: "For timestamp conversion: Enter your Unix timestamp and select the format (seconds, milliseconds, microseconds, or nanoseconds). For date conversion: Select your date and time using the date picker",
    },
    {
      name: "Select Timezone",
      text: "Choose your desired timezone from the dropdown menu. Supports UTC, EST, PST, GMT, JST, IST, and many other major timezones",
    },
    {
      name: "Convert and View Results",
      text: "Click the convert button to see detailed results including ISO 8601, RFC 2822, locale string formats, and individual date components",
    },
    {
      name: "Copy or Download Results",
      text: "Use the copy button to copy results to clipboard, or download as PNG, PDF, or CSV for sharing and documentation",
    },
  ]);
    ...
    >
      ...
      >
        ...
        <Box sx={{ mt: 6 }}>
          <SocialShare
            url={shareLink}
            title="Timestamp Converter - Convert Unix Timestamps to Human-Readable Dates"
            description="Free online timestamp converter with support for multiple formats and timezones. Convert between Unix timestamps and human-readable dates instantly."
            hashtags={[
              "timestamp",
              "converter",
              "unix",
