...
const Stopwatch = () => {
  ...
  const seoData = generateToolSEO(
    "Stopwatch",
    "Precision online stopwatch with lap tracking, millisecond accuracy, and advanced timing features. Perfect for sports, workouts, cooking, and professional time measurement with export capabilities",
    "time"
  );
  ...
  const webAppData = generateWebAppData(
    "Stopwatch",
    "Precision online stopwatch with lap tracking, millisecond accuracy, and advanced timing features. Perfect for sports, workouts, cooking, and professional time measurement",
    "time"
  );

  const howToData = generateHowToData("Stopwatch", [
    {
      name: "Start the Timer",
      text: "Click the 'Start' button to begin timing. The stopwatch will display time in MM:SS.MS format with millisecond precision for accurate measurements",
    },
    {
      name: "Record Lap Times",
      text: "While the stopwatch is running, click the 'Lap' button to record split times. Each lap shows both the lap duration and total elapsed time",
    },
    {
      name: "Pause and Resume",
      text: "Use the 'Pause' button to temporarily stop timing, then 'Resume' to continue. Perfect for timing activities with breaks or interruptions",
    },
    {
      name: "View Statistics",
      text: "See comprehensive statistics including total laps, best lap time, worst lap time, and average lap time with visual indicators for performance analysis",
    },
    {
      name: "Export Results",
      text: "Download your timing results as PNG images, PDF documents, or CSV files. Copy results to clipboard for easy sharing and documentation",
    },
  ]);
  ...
  const [autoLapInterval, setAutoLapInterval] = useState(60); // seconds
    ...
    >
      ...
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            description:
              "Precision stopwatch with lap tracking and export capabilities",
      ...
      >
        ...
        <Box sx={{ mt: 6 }}>
          <SocialShare
            url={shareLink}
            title="Precision Stopwatch with Lap Tracking - KodeKit"
            description="Free online stopwatch with millisecond accuracy, lap tracking, and export features. Perfect for sports, workouts, and professional timing."
            hashtags={[
              "stopwatch",
              "timer",
              "sports",
