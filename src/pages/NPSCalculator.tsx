...
const NPSCalculator = () => {
  ...
  const seoData = generateToolSEO(
    "NPS Calculator",
    "Calculate National Pension System returns, retirement corpus, and pension amount with our free NPS calculator. Plan your retirement with accurate projections",
    "finance"
  );

  const webAppData = generateWebAppData(
    "NPS Calculator",
    "Free online NPS calculator to calculate returns on National Pension System investments. Get detailed projections for your retirement planning with pension analysis.",
    "finance"
  );
  ...
  const howToSteps = [
    {
      ...
      text: "Input your current age (minimum 18 years for NPS)",
    },
    {
      name: "Set Retirement Age",
      text: "Enter your planned retirement age (minimum 60 years)",
    },
    {
      name: "Monthly Contribution",
      text: "Enter your monthly NPS contribution amount",
    },
    {
      name: "Expected Return",
      text: "Set the expected annual return rate from NPS investments",
    },
    {
      name: "Calculate NPS",
      text: "Click 'Calculate NPS' to see retirement corpus, pension amount, and year-wise growth projections",
    },
  ];

  const howToData = generateHowToData("NPS Calculator", howToSteps);

  const breadcrumbData = generateBreadcrumbData([
    { name: "Home", url: "https://kodekit.in" },
    { name: "Finance Tools", url: "https://kodekit.in/category/finance" },
    { name: "NPS Calculator", url: "https://kodekit.in/tools/nps-calculator" },
  ]);
