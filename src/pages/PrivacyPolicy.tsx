...
const PrivacyPolicy = () => {
  ...
  const privacyPolicyJsonLd = {
    ...
    "@type": "WebPage",
    name: "KodeKit Privacy Policy",
    description:
      "Comprehensive privacy policy explaining how KodeKit protects user privacy with client-side processing and zero data collection.",
    url: "https://kodekit.in/privacy-policy",
    mainEntity: {
      "@type": "PrivacyPolicy",
      name: "KodeKit Privacy Policy",
  ...
  return (
    ...
    >
      <Helmet>
        <title>Privacy Policy - KodeKit | Your Privacy is Our Priority</title>
        <meta
          name="description"
          content="KodeKit's comprehensive privacy policy. Learn how we protect your privacy with client-side processing, zero data collection, and transparent practices."
        />
        <meta
          name="keywords"
          content="KodeKit privacy policy, data protection, client-side processing, zero data collection, privacy first, GDPR compliance, user privacy"
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://kodekit.in/privacy-policy" />

        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content="Privacy Policy - KodeKit | Your Privacy is Our Priority"
        />
        <meta
          property="og:description"
          content="Learn how KodeKit protects your privacy with client-side processing and zero data collection."
        />
        <meta property="og:url" content="https://kodekit.in/privacy-policy" />
        ...
        <script type="application/ld+json">
          {JSON.stringify(privacyPolicyJsonLd)}
        </script>
      </Helmet>
                        ...
                        <CardContent sx={{ p: 3, textAlign: "center" }}>
                          <Box
                            sx={{
                              ...
                              color:
                                theme.palette[
                                  principle.color as keyof typeof theme.palette
                                ].main,
                            }}
                          >
                            {principle.icon}
