...
const LumpsumCalculator = () => {
  ...
  const seoData = generateToolSEO(
    "Lumpsum Calculator",
    "Calculate lumpsum investment returns, maturity amount, and wealth growth with our free lumpsum calculator. Plan your one-time investments with accurate projections",
    "finance"
  );

  const webAppData = generateWebAppData(
    "Lumpsum Calculator",
    "Free online lumpsum calculator to calculate returns on one-time investments. Get detailed projections for your lumpsum investments with compound growth analysis.",
    "finance"
  );
  ...
  const howToSteps = [
    {
      ...
      text: "Input your one-time lumpsum investment amount",
    },
    {
      name: "Set Expected Return",
      text: "Enter the expected annual return rate from your investment",
    },
    {
      name: "Choose Investment Period",
      text: "Select the duration for which you want to invest",
    },
    {
      name: "Calculate Returns",
      text: "Click 'Calculate Lumpsum' to see maturity amount, total gains, and year-wise growth projections",
    },
    {
      name: "View Growth Schedule",
      text: "Analyze the detailed year-wise breakdown of compound growth and investment value",
    },
  ];

  const howToData = generateHowToData("Lumpsum Calculator", howToSteps);
  ...
  const breadcrumbData = generateBreadcrumbData([
    ...
    { name: "Finance Tools", url: "https://kodekit.in/category/finance" },
    {
      ...
      url: "https://kodekit.in/tools/lumpsum-calculator",
    },
  ]);
