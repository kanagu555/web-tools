    ...
    for (let i = 0; i < newColors.length; i++) {
      if (i !== baseColorIndex && !newColors[i].locked) {
        ...
        switch (colorMode) {
          ...
          case "monochromatic":
            newHsl.s = Math.min(
              Math.max(baseHsl.s + (i - baseColorIndex) * 0.1, 0),
              1
            );
            newHsl.l = Math.min(
              Math.max(baseHsl.l + (i - baseColorIndex) * 0.1, 0),
              1
            );
            break;
          case "triadic":
          ...
          case "complementary":
            ...
            newHsl.s = Math.min(
              Math.max(baseHsl.s + (i - baseColorIndex) * 0.05, 0),
              1
            );
            newHsl.l = Math.min(
              Math.max(baseHsl.l + (i - baseColorIndex) * 0.1, 0),
  ...
  return (
    <Paper className={classes.paper}>
      ...
      <Box sx={{ mt: 4 }}>
        ...
        >
          • Generate harmonious color schemes with different color theory
          methods
        </Typography>
        ...
        <Typography
          ...
          sx={{ display: "flex", alignItems: "center", gap: 1 }}
        >
          • Fine-tune colors with RGB sliders and hex input
        </Typography>
        ...
        <Typography
          ...
          sx={{ display: "flex", alignItems: "center", gap: 1 }}
        >
          • Export colors in multiple formats (HEX, RGB, CSS variables)
        </Typography>
