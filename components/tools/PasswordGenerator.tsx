...
const PasswordGenerator: React.FC = () => {
  ...
  const generatePassword = () => {
    ...
    trackTool("password-generator", "generate");
  };
  ...
  const resetForm = () => {
    ...
    setSnackbarOpen(true);
    trackTool("password-generator", "reset");
  };
  ...
  const copyToClipboard = () => {
    ...
    navigator.clipboard
      ...
      .then(() => {
        ...
        setSnackbarOpen(true);
        trackTool("password-generator", "copy");
      })
      .catch((err) => {
  ...
  const downloadPassword = () => {
    ...
    setSnackbarOpen(true);
    trackTool("password-generator", "download");
  };
  ...
  const togglePasswordVisibility = () => {
    ...
    trackTool("password-generator", showPassword ? "hide" : "show");
  };
      ...
      >
        ...
        <Box sx={{ mb: 4 }}>
          <Typography
            ...
            sx={{ mb: 4 }}
          >
            Create secure, random passwords with customizable options for all
            your accounts.
          </Typography>
          ...
          <Grid container spacing={2} sx={{ mt: 2 }}>
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                ...
                <Typography variant="body2">
                  ...
                  length and character types for maximum protection.
                </Typography>
              </Paper>
            </Grid>
            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                ...
                <Typography variant="body2">
                  All passwords are generated locally in your browser. Nothing
            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                ...
                <Typography variant="body2">
                  Control password length, character types, and exclude similar
        ...
        <Box sx={{ mt: 6 }}>
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                ...
                <Box sx={{ display: "flex", alignItems: "flex-start", mb: 1 }}>
                  ...
                  <Typography>
                    <strong>Use a password manager</strong> to store and
          ...
          >
            <Typography
              ...
              sx={{ fontWeight: 500 }}
            >
              🔒 Privacy Note: This password generator creates passwords locally
              in your browser. Your generated passwords are never sent to our
