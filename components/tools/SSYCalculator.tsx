  ...
  const downloadAsPNG = async (timestamp: string) => {
    ...
    enhancedContent.innerHTML = `
      ...
      <div style="margin-top: 30px; text-align: center; font-size: 12px; border-top: 1px solid #ddd; padding-top: 20px;">
        <span style="color: #000; font-weight: 900;">Generated by www.KodeKit.in SSY Calculator</span> | <span style="color: #666;">${window.location.href
      }</span>
      </div>
    `;
            ...
            >
              ...
              >
                ...
                <Typography variant="body2" color="text.secondary">
                  ...
                  <br />• Partial withdrawal allowed after 18 years
                </Typography>
              </Box>
            </Paper>
          </Grid>
                    ...
                    <Grid item xs={12} sm={4}>
                      ...
                      >
                        <CardContent>
                          ...
                          >
                            ₹
                            {ssyResult.maturityAmount.toLocaleString("en-IN", {
                              maximumFractionDigits: 0,
                            })}
                          </Typography>
                    ...
                    <Grid item xs={12} sm={4}>
                      ...
                      >
                        <CardContent>
                          ...
                          >
                            ₹
                            {ssyResult.totalInvestment.toLocaleString("en-IN", {
                              maximumFractionDigits: 0,
                            })}
                          </Typography>
                          <Typography variant="body2" sx={{ opacity: 0.9 }}>
            ...
            <Grid container spacing={4}>
              <Grid item xs={12} md={6}>
                ...
                <Typography variant="body1" paragraph>
                  ...
                  designed to secure the financial future of girl children. It
                  offers attractive interest rates and tax benefits under the
