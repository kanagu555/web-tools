      ...
      >
        ...
        <Box sx={{ mt: 4 }} component="section">
          ...
          <Typography variant="body1" paragraph>
            1. <strong>Select a tool</strong> - Choose from rectangle, circle,
            text, or line tools
          </Typography>
          <Typography variant="body1" paragraph>
            2. <strong>Add shapes</strong> - Click a tool button to add shapes
            to the canvas
          </Typography>
          <Typography variant="body1" paragraph>
            3. <strong>Edit properties</strong> - Select shapes to modify
            position, colors, and stroke width
          </Typography>
          <Typography variant="body1" paragraph>
