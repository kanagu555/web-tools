      ...
      >
        <Box component="header" sx={{ mb: 4 }}>
          ...
          >
            ...
            investment growth projections. Plan your tax-saving investments with
            accurate PPF calculations and investment schedules.
          </Typography>
        </Box>
            ...
            >
              ...
              >
                ...
                <Typography variant="body2" color="text.secondary">
                  ...
                  <br />• Partial withdrawal allowed after 7th year
                </Typography>
              </Box>
            </Paper>
          </Grid>
                    ...
                    <Grid item xs={12} sm={4}>
                      ...
                      >
                        <CardContent>
                          ...
                          >
                            ₹
                            {ppfResult.totalInvestment.toLocaleString("en-IN", {
                              maximumFractionDigits: 0,
                            })}
                          </Typography>
                          <Typography variant="body2" sx={{ opacity: 0.9 }}>
            ...
            <Grid container spacing={4}>
              <Grid item xs={12} md={6}>
                ...
                <Typography variant="body1" paragraph>
                  ...
                  scheme that offers attractive interest rates and tax benefits.
                  It's designed to help individuals build a retirement corpus
                  while saving taxes.
                </Typography>
