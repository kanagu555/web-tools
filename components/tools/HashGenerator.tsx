...
const HashGenerator: React.FC = () => {
  ...
  const generateHash = async () => {
    ...
    try {
      ...
      if (tabValue === 0) {
        ...
        data = await fileInputRef.current.files[0].arrayBuffer();
      }
      ...
      trackTool("hash-generator", `generate_${hashType}`);
    } catch (error) {
  ...
  const handleFileUpload = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      trackTool("hash-generator", "file_upload");
  ...
  const handleTabChange = (_event: React.SyntheticEvent, newValue: number) => {
    ...
    setIsMatch(null);
    trackTool("hash-generator", newValue === 0 ? "switch_text" : "switch_file");
  };
  ...
  const clearAll = () => {
    ...
    trackTool("hash-generator", "clear");
  };
  ...
  const toggleCompareMode = () => {
    ...
    trackTool(
      "hash-generator",
      compareMode ? "disable_compare" : "enable_compare"
    );
  };
  ...
  const downloadHash = () => {
    ...
    trackTool("hash-generator", "download");
  };
      ...
      >
        ...
        <Box sx={{ mb: 4 }}>
          ...
          >
            ...
            integrity and security. Supports MD5, SHA-1, SHA-256, SHA-384, and
            SHA-512 algorithms.
          </Typography>
        ...
        <Box sx={{ mt: 6 }}>
          ...
          <Typography variant="body1" paragraph>
            Hash functions are essential cryptographic tools that convert data
            of any size into a fixed-size string of characters. They are
            designed to be one-way functions, meaning it's practically
            impossible to reverse the process and obtain the original data from
            the hash.
          </Typography>
          ...
          <Grid container spacing={3} sx={{ mt: 2 }}>
            <Grid item xs={12} md={6}>
              ...
              >
                ...
                <Typography variant="body2" paragraph>
                  <strong>SHA-256:</strong> Part of the SHA-2 family, it
                  produces a 256-bit (32-byte) hash value. It's widely used for
                  data integrity verification and is considered secure for most
                  applications.
                </Typography>
                <Typography variant="body2" paragraph>
                  <strong>SHA-512:</strong> Produces a 512-bit hash value,
                  offering even greater security than SHA-256. Recommended for
                ...
                <Typography variant="body2">
                  <strong>SHA-1:</strong> Produces a 160-bit hash value. Like
                  MD5, it's no longer considered secure for cryptographic
                  purposes but is still used in some legacy systems.
                </Typography>
              </Paper>
            </Grid>
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                ...
                <Typography variant="body2" paragraph>
                  <strong>Data Integrity:</strong> Verify that files haven't
                  been corrupted during transfer or storage by comparing hash
                  values.
                </Typography>
                <Typography variant="body2" paragraph>
                  <strong>Password Storage:</strong> Securely store password
                  hashes instead of plaintext passwords in databases.
                </Typography>
                <Typography variant="body2" paragraph>
                  <strong>Digital Signatures:</strong> Verify the authenticity
                  and integrity of digital documents and software.
                </Typography>
                <Typography variant="body2" paragraph>
                ...
                <Typography variant="body2">
                  <strong>Data Deduplication:</strong> Identify duplicate data
                  by comparing hash values instead of the entire content.
                </Typography>
              </Paper>
            </Grid>
          </Grid>
