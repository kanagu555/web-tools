...
export const LazyPdfMerger = dynamic(
  () => import('./tools/PdfMerger'),
  {
    loading: LoadingSkeleton,
    ssr: false,
  }
...
export const LazyPdfSplitter = dynamic(
  () => import('./tools/PdfSplitter'),
  {
    loading: LoadingSkeleton,
    ssr: false,
  }
...
export const LazyImageResizer = dynamic(
...
export const LazySvgEditor = dynamic(
  () => import('./tools/SvgEditor'),
  {
    loading: LoadingSkeleton,
    ssr: false,
  }
...
// Text tools
export const LazyWordCount = dynamic(
  () => import('./tools/WordCount'),
  {
    loading: LoadingSkeleton,
  }
);
...
export const LazyJsonCompare = dynamic(
  () => import('./tools/JsonCompare'),
  {
    loading: LoadingSkeleton,
  }
);
...
export const LazyCssMinifier = dynamic(
  () => import('./tools/CssMinifier'),
  {
    loading: LoadingSkeleton,
  }
);
...
export const LazyRegexTester = dynamic(
  () => import('./tools/RegexTester'),
  {
    loading: LoadingSkeleton,
  }
);
...
export const LazyJwtDecoder = dynamic(
...
export const LazySyntaxHighlighter = dynamic(
  () => import('react-syntax-highlighter').then(mod => ({ default: (mod as any).Prism })),
  {
    loading: LoadingSpinner,
    ssr: false,
  }
...
export const LazyAdSense = dynamic(
  () => import('./AdSense'),
  {
    ssr: false,
  }
